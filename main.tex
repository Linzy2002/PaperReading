...
\subsection{Glueball Spectrum and Matrix Elements on Anisotropic Lattices}

Title: Glueball Spectrum and Matrix Elements on Anisotropic Lattices\cite{Chen:2005mg}

高被引的文章，介绍了格点计算胶球的矩阵元的结果，最后也展示了详细的能谱结构。


\subsection{Spinless glueballs in generalized linear sigma model
}

Title:Spinless glueballs in generalized linear sigma model \cite{Fariborz:2025ybo}

新文章，用linear sigma model 对有哪些态是胶球进行了分析，但是不像格点那样给出了明确的能谱。
...
计算charmonia的GFF的文章，与计算胶球的步骤类似。


\subsection{Lattice evidence that scalar glueballs are small}

Title: Lattice evidence that scalar glueballs are small\cite{Abbott:2025irb}

格点计算胶球GFF的文章，没有给出具体的质量谱。
